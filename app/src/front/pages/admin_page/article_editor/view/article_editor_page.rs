                                ...
                                view! {
                                    ...
                                    >
                                        <div class=style::editor_toolbar>
                                            <div class=style::editor_tools>
                                                ...
                                                <button
                                                    ...
                                                    on:click=move |_| {
                                                        form.is_fullscreen.update(|v| *v = !*v)
                                                    }
                                                >
                                                    {move || {
                                                        if form.is_fullscreen.get() {
                                        ...
                                        <div
                                            ...
                                            class:split=move || {
                                                form.view_mode.get() == ViewMode::Split
                                            }
                                        >
                                            <Show when=move || {
                                                ...
                                                <div class=style::editor_pane>
                                                    <textarea
                                                        ...
                                                        on:input=move |ev| {
                                                            form.body.set(event_target_value(&ev))
                                                        }
                                                        on:scroll=move |_| {
                                                            use_scroll_sync(editor_ref, preview_ref)
                                                        }
                                            ...
                                            <Show when=move || {
                                                form.view_mode.get() != ViewMode::Editor
                                            }>
